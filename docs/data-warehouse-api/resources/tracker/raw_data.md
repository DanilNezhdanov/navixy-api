...
To retrieve an internal value from a complex column, use the period symbol. For example: `flags.location_valid`, `inputs.board_voltage`. Unknown internal values will be returned as `NULL`.
